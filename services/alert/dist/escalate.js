 ...
 */
export function nextEscalationState(incident, policy, now) {
...
export function initialEscalationState(policy, now) {
 ...
 */
export async function runDueEscalations(store, driver, now) {
...
export class EscalationLoop {
    ...
    onError;
    timer = null;
    constructor(store, driver, intervalMs, onError = () => { }) {
        this.store = store;
        this.driver = driver;
