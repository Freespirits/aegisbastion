...
export function loadValidators(schemaDir = process.env.SCHEMA_DIR ?? defaultSchemaDir()) {
    ...
    return {
        alertEvent: ajv.getSchema(ALERT_EVENT_SCHEMA_ID),
        envelope: ajv.getSchema(ALERT_ENVELOPE_SCHEMA_ID),
    };
}
